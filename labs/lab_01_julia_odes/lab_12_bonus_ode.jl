...
# ╔═╡ 6afe0c6e-57ff-4b11-8837-de7a2561fa9f
md"""
# Programming Multibody Systems in Julia

### Lab 2.1: ODEs and mass-spring-damper system
...
$(embed_image("../../assets/figures/lab_12_bonus_mass_spring.jpg", type="jpg", height=150))
"""

# ╔═╡ 92662875-eb2d-43c1-ae3a-a6cb98d65cfe
md"""
The figure presents the system of three masses connected by springs.  Exemplary data for the model are:
-  $m_1 = 2\text{ kg}$,  
-  $m_2 = 1.5\text{ kg}$,  
-  $m_3 = 1\text{ kg}$,  
-  $k_1 = 20000\text{ N/m}$,  
...
we define modal coordinates by

$$\boldsymbol{x} \;=\; \Psi\,\boldsymbol{p}.$$

Now we can transform the original system to

$$\hat{\boldsymbol{M}}\,\ddot{\boldsymbol{p}} \;+\;\hat{\boldsymbol{K}}\,\boldsymbol{p} \;=\; \hat{\boldsymbol{F}},$$
   
where
   
$$\hat{\boldsymbol{M}} = \Psi^{T}\,\boldsymbol{M}\,\Psi,\quad
     \hat{\boldsymbol{K}} = \Psi^{T}\,\boldsymbol{K}\,\Psi,\quad
     \hat{\boldsymbol{F}} = \Psi^{T}\,\boldsymbol{F}.$$

   Verify that $\hat{\boldsymbol{M}} = \boldsymbol{I}$ and $\hat{\boldsymbol{K}} = \Lambda$, and compare the modal‐coordinate solution with the original system.
"""
...
manifest_format = "2.0"
project_hash = "886e032b5d5a89dcaff39c7c600477200d3b2bcf"
