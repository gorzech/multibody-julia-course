...
# ╔═╡ de8606d0-e7fa-464b-81a4-e98d8f201984
using LinearAlgebra
...
# ╔═╡ c1158c8e-4487-4328-8da7-ee09d6a67919
...
# ╔═╡ bfbb298f-da8c-46b4-9bbf-1d5e27db70c5
sol = solve(prob)

# ╔═╡ ae40b114-181c-4c1c-9c60-5ae9afef73fd
plot(sol, label="u(t)", xlabel="Time", ylabel="Value")

# ╔═╡ 05daf1b1-9709-4108-9280-855906f42ec1
md"""
...
# ╔═╡ 6e8c309e-6367-4963-922a-0f68bc336974
...
# ╔═╡ da1d974a-dc87-4340-99c1-fa4570bab062
# Initial conditions
begin
	q0 = [1.0, 0.0, 0.0, 0.0]
	ω0 = [0.1, 0.2, 0.3]
...
# ╔═╡ 5feeeca2-86dc-431b-adc8-ae1a51593541
tspan_rb = (0.0, 10.0)

# ╔═╡ e2f92595-584e-4230-9e7a-d4d17e202ac1
prob_rb = ODEProblem(rigid_body!, u0_rb, tspan_rb)

# ╔═╡ 8d8c151b-dcea-4f7d-9afe-1964a677c54b
sol_rb = solve(prob_rb)

# ╔═╡ 19779a77-f384-46d4-97d8-810a37099a1b
